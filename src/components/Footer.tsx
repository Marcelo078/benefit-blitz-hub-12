      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="text-xl font-bold text-foreground">Benefit Blitz Hub</h3>
            </div>
            <p className="text-muted-foreground mb-4 max-w-md">
              Descubra os melhores produtos selecionados especialmente para você. 
              Qualidade, eficácia e resultados comprovados em cada recomendação.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#emagrecimento" className="text-muted-foreground hover:text-primary transition-colors">
                  Emagrecimento
                </a>
              </li>
              <li>
                <a href="#saude" className="text-muted-foreground hover:text-primary transition-colors">
                  Saúde e Bem-estar
                </a>
              </li>
              <li>
                <a href="#beleza" className="text-muted-foreground hover:text-primary transition-colors">
                  Beleza
                </a>
              </li>
              <li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm">
            © 2024 Benefit Blitz Hub. Todos os direitos reservados.
          </p>
          <p className="text-muted-foreground text-sm mt-2 md:mt-0">
            Desenvolvido com ❤️ para conectar você aos melhores produtos
          </p>
        </div>
      </div>
    </footer>
